...
|---|---|---|---|---|---|---|
| 1 | Critical access and catalog smoke | Prove a valid family/admin path can enter and see the catalog in the cheapest deployed-like way. | #1, #2 | contract + smoke | planned | `context/changes/testing-critical-access-catalog-smoke/` |
| 2 | Catalog mutation contracts | Lock list/search/add/update/delete durable behavior before expanding UI tests. | #3, #5, #6 | contract + integration | not started | - |
